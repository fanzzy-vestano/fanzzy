...
-- Safe upgrade for an existing products table created before cost price was added.
...
insert into public.products (sku, name, category, stock, price, cost, status, image, hover_image, compare_at, tag, tone)
values
  ('LST-AUR-01', 'Aurora Drop Earrings', 'Earrings', 24, 1290, 645, 'Published', 'https://images.unsplash.com/photo-1635767798638-3e25273a8236?auto=format&fit=crop&w=900&q=85', 'https://images.unsplash.com/photo-1535632066927-ab7c9ab60908?auto=format&fit=crop&w=900&q=85', 1690, 'Bestseller', '#d9c4bc'),
  ('LST-SOL-02', 'Solstice Tennis Necklace', 'Necklaces', 8, 2480, 1240, 'Low stock', 'https://images.unsplash.com/photo-1617038220319-276d3cfab638?auto=format&fit=crop&w=900&q=85', 'https://images.unsplash.com/photo-1599643478518-a784e5dc4c8f?auto=format&fit=crop&w=900&q=85', null, 'New in', '#dad7ce'),
  ('LST-MUS-03', 'Muse Sculpted Cuff', 'Bracelets', 0, 1860, 930, 'Draft', 'https://images.unsplash.com/photo-1611652022419-a9419f74343d?auto=format&fit=crop&w=900&q=85', 'https://images.unsplash.com/photo-1573408301185-9146fe634ad0?auto=format&fit=crop&w=900&q=85', 2200, 'Limited', '#d0c2b0'),
  ('LST-ORB-04', 'Orbital Pearl Ring', 'Rings', 41, 990, 495, 'Published', 'https://images.unsplash.com/photo-1605100804763-247f67b3557e?auto=format&fit=crop&w=900&q=85', 'https://images.unsplash.com/photo-1603561596112-0a132b757442?auto=format&fit=crop&w=900&q=85', null, null, '#e5ddd1')
