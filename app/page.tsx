...
export default function Home() {
  ...
  const openQuickProduct = useCallback((product: Product, selection?: { variantName?: string; size?: string }) => {
  ...
  const openOrderedProduct = (item: NonNullable<CustomerOrder["items"]>[number]) => {
    ...
    openQuickProduct(product, { variantName: variant || undefined, size: size || undefined });
  };
